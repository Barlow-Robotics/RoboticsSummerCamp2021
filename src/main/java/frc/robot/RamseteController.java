...
public class RamseteController {
  ...
  public ChassisSpeeds calculate(
    ...
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/currentPose/x").setDouble(currentPose.getTranslation().getX()) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/currentPose/y").setDouble(currentPose.getTranslation().getY()) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/currentPose/rotation").setDouble(currentPose.getRotation().getDegrees()) ;

    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseRef/x").setDouble(poseRef.getTranslation().getX()) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseRef/y").setDouble(poseRef.getTranslation().getY()) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseRef/rotation").setDouble(poseRef.getRotation().getDegrees()) ;


    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseError/x").setDouble(eX) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseError/y").setDouble(eY) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/poseError/theta").setDouble(eTheta) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/vRef").setDouble(vRef) ;
    NetworkTableInstance.getDefault().getEntry("ramsetcontroller/omegaRef").setDouble(omegaRef) ;
